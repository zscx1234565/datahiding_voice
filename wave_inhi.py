...
def ypyincang(File):
    ...
    for k in sec3:  # 读取秘密信息的数字形式
        ...
        if i <= o-1:
            ...
            # if z == 13057:
            #     print(x1,x2)
            # if int(M[x1][x2])==int(k):
            #     print("WaOoooo",z)
            if x1 == 0 and x2 == 0 :#写的有点复杂回头修改一下
                list1 = [M[x1][x2], M[x1][x2 + 1], M[x1 + 1][x2], M[x1 + 1][x2 + 1],
            ...
            if x1 == 255 and 0 < x2 < 255:
                list1 = [M[x1][x2], M[x1][x2 - 1], M[x1][x2 + 1], M[x1 - 1][x2], M[x1 - 1][x2 - 1],
                         M[x1 - 2][x2], M[x1 - 2][x2 - 1], M[x1 - 2][x2 + 1]]
            ...
            if x1 == 255 and x2 == 255:
                ...
                j=j+2
                continue
            if 0 < x1 < 255 and x1%2 == 0 and x2 == 255:
                list1 = [M[x1][x2], M[x1][x2 - 1], M[x1][x2 - 2], M[x1 - 1][x2], M[x1 - 1][x2 - 1],
                         M[x1 - 1][x2 - 2], M[x1 + 1][x2], M[x1 + 1][x2 - 1]]
                ...
                j=j+2
                continue
            if 0 < x1 < 255 and x2 == 255 and x1 % 2 == 1:
                list1 = [M[x1][x2], M[x1][x2 - 1], M[x1 - 1][x2], M[x1 - 1][x2 - 1],
            ...
            if x1 == 255 and x2 == 0:
                ...
                j=j+2
                continue
            if 0<x1<255 and x2 == 0 and x1 % 2 == 0:
                list1 = [M[x1][x2], M[x1][x2 + 1], M[x1 - 1][x2], M[x1 - 1][x2 + 1],
                         M[x1 - 1][x2 + 2], M[x1 + 1][x2], M[x1 + 1][x2 + 1], M[x1 + 1][x2 + 2]]
                ...
                j = j + 2
                continue
            if 0<x1<255 and x2 == 0 and x1 % 2 == 1:

                list1 = [M[x1][x2], M[x1][x2 + 1], M[x1][x2 + 2], M[x1 - 1][x2], M[x1 - 1][x2 + 1],
                          M[x1 + 1][x2], M[x1 + 1][x2 + 1], M[x1 + 1][x2 + 2]]
            ...
            if 255 > x1 >= 1 and 255 > x2 >= 1:
                ...
                if a == 1 and b == 0 and c == 1:  # 在龟壳背部上一元素嵌入算法
                    # print(a)
                    ...
                    while m <= len(list1) - 1:
                        ...
                        m = m + 1
                    # print(4)
                if a == 1 and b == 0 and c == 0:  # 在龟壳背部下一元素嵌入算法
                    list1 = [M[x1][x2], M[x1][x2 + 1], M[x1][x2 - 1], M[x1 + 1][x2 + 1],
                ...
                if a == 0 and b == 1 and c == 1:  # 在龟壳背部上一元素嵌入算法
                    list1 = [M[x1][x2], M[x1][x2 + 1], M[x1][x2 - 1], M[x1 + 1][x2],
                             M[x1 - 1][x2 + 1], M[x1 - 1][x2], M[x1 - 1][x2 - 1], M[x1 - 2][x2]]
                    # print(list1,k)
                    m = 0
    ...
    img = Image.fromarray(img).save("D:/123/TEST/ypinfhided.tif")
    # # img.show()
