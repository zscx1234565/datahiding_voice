...
def ypyincang(File):
    ...
    M = secure_gen.sec_genb(ini_valu)
    # print(shape(M))
    # 嵌入秘密信息
        ...
        if i <= o-1:
            ...
            if 0 < x1 < 255 and 0 < x2 < 255:
                ...
                list1 = [M[x1][x2], M[x1][x2 + 1], M[x1][x2 - 1], M[x1 + 1][x2],
                         ...
                         M[x1 + 2][x2], M[x1 + 2][x2-1], M[x1 + 2][x2 + 1], M[x1 + 2][x2 +2], M[x1 + 1][x2 + 2],
                         M[x1][x2 + 2], M[x1 - 1][x2 + 2]]
                # list1 = [hex(a) for a in list1]
                m = 0
                while m <= (len(list1) - 1):

                    if int(list1[m]) == int('0x'+str(k),16):
                        # print(m, list1[m], k)
                        if m == 1:
                            x2 = x2 + 1
                            break
            ...
            g = int(img[i][j + 1])
                ...
                # print(int(M[f][g]))
            j = j + 2
            print(int('0x'+str(k),16))
            if int('0x'+str(k),16) != int(M[x1][x2]):
